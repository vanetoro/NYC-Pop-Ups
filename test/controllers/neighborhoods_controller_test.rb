...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: { name: @neighborhood.name } }, as: :json
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { name: @neighborhood.name } }, as: :json
    assert_response 200
  end
