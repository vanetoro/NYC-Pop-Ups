...
var CONVENTIONAL_DIRECT_UPLOADS_PATH = '/rails/active_storage/direct_uploads';
...
var Upload = function () {
  createClass(Upload, [{
    ...
    get: function get$$1() {
      var _options$endpoint = this.options.endpoint,
          host = _options$endpoint.host,
          protocol = _options$endpoint.protocol,
          port = _options$endpoint.port;

      if (host) {
        var builtProtocol = protocol ? protocol.split(':')[0] + '://' : 'https://';
        var builtPort = port ? ':' + port : '';
  ...
  function Upload(file, options) {
    ...
    Object.defineProperty(this, 'handleChangeFile', {
      enumerable: true,
      writable: true,
      value: function value(upload) {
        _this.options.onChangeFile(defineProperty({}, _this.id, upload));
      }
    });
    Object.defineProperty(this, 'handleProgress', {
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(this, 'handleSuccess', {
      enumerable: true,
      writable: true,
      value: function value(signedId) {
        _this.handleChangeFile({
          state: 'finished',
          id: _this.id,
          file: _this.directUpload.file
    ...
    this.handleChangeFile({ state: 'waiting', id: this.id, file: file });
  }
...
var ActiveStorageProvider = function (_React$Component) {
  ...
  function ActiveStorageProvider() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ActiveStorageProvider.__proto__ || Object.getPrototypeOf(ActiveStorageProvider)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, 'state', {
      enumerable: true,
      writable: true,
      value: {
        uploading: false,
    ...
    }), Object.defineProperty(_this, 'handleChooseFiles', {
      enumerable: true,
      writable: true,
      value: function value(files) {
        ...
        _this.setState({ uploading: true }, function () {
          Promise.all([].concat(toConsumableArray(files)).map(function (file) {
            return _this._upload(file);
          })).then(function (ids) {
            _this._hitEndpointWithSignedIds(ids).then(function (data) {
              _this.setState({ files: {}, uploading: false });
  ...
  createClass(ActiveStorageProvider, [{
    ...
    value: function render() {
      ...
      return this.props.render({
        ...
        uploads: Object.keys(files).map(function (key) {
          return files[key];
        })
      });
    }
    ...
    value: function _upload(file) {
      ...
      var _props = this.props,
          ...
          onBeforeBlobRequest = _props.onBeforeBlobRequest,
          onBeforeStorageRequest = _props.onBeforeStorageRequest;
      ...
      return new Upload(file, {
        ...
        onChangeFile: function onChangeFile(fileUpload) {
          return _this2.setState(function (_ref2) {
            var files = _ref2.files;
            return { files: _extends({}, files, fileUpload) };
          });
        }
      }).start();
    }
    ...
    value: function _hitEndpointWithSignedIds(signedIds) {
      ...
      var body = defineProperty({}, model.toLowerCase(), defineProperty({}, attribute, multiple ? signedIds : signedIds[0]));
...
module.exports = ActiveStorageProvider;
